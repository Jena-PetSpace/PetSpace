...
class ErrorMessages {
  ...
  static const String missingRequiredData =
      '필수 정보가 누락되었습니다.\n모든 필수 항목을 입력해주세요.';
  ...
  static const String imageProcessingFailed =
      '이미지 처리 중 오류가 발생했습니다.\n다른 이미지를 선택해주세요.';
  ...
  static const String healthRecordCreateFailed =
      '건강 기록 저장에 실패했습니다.\n다시 시도해주세요.';
  static const String healthRecordUpdateFailed =
      '건강 기록 수정에 실패했습니다.\n다시 시도해주세요.';
