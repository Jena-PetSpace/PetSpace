...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<Either<Failure, user_entity.User>> signInWithGoogle() async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '구글 로그인 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, user_entity.User>> signInWithApple() async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: 'Apple 로그인 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, user_entity.User>> signInWithKakao() async {
    ...
    try {
      ...
      log('❌ [Kakao Login] Unknown Exception', name: 'AuthRepository');
  ...
  Future<Either<Failure, user_entity.User>> signUpWithEmail(
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '회원가입 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> deleteAccount() async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '계정 삭제 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> restoreAccount() async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '계정 복구 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, user_entity.User?>> getCurrentUser() async {
    try {
      ...
      return const Left(
        GeneralFailure(message: '사용자 정보 조회 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, user_entity.User>> updateUserProfile(
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '프로필 업데이트 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, String>> uploadProfileImage(String imagePath) async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '이미지 업로드 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> resetPassword(String email) async {
    ...
    try {
      ...
      return const Left(
        GeneralFailure(message: '비밀번호 재설정 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, void>> sendEmailVerification() async {
    try {
      ...
      return const Left(
        GeneralFailure(message: '이메일 인증 발송 중 오류가 발생했습니다.'),
      );
    }
  }
  ...
  Future<Either<Failure, bool>> isEmailVerified() async {
    try {
      ...
      return const Left(
        GeneralFailure(message: '이메일 인증 상태 확인 중 오류가 발생했습니다.'),
      );
    }
  }
