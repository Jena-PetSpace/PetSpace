    ...
    try {
      ...
      if (lastUserId != null) {
        cursor = await supabaseClient
            ...
            .eq('id', lastUserId)
            .maybeSingle();
        if (cursor == null || cursor['created_at'] == null) {
      ...
      if (cursor != null) {
        ...
        final cursorId = _quotePostgrestValue(cursor['id'] as String);
        dbQuery = dbQuery.or(
          'created_at.lt.$createdAt,'
          'and(created_at.eq.$createdAt,id.lt.$cursorId)',
        );
      }
